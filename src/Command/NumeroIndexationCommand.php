...
class NumeroIndexationCommand extends Command
{
    protected static $defaultName = 'app:numero-indexation';
    protected static $defaultDescription = 'Numeros indexing';
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                'This command allows to indexing the numeros from database.'
            )
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $fileLock = $this->kernel->getProjectDir().$ds.'var'.$ds.'log'.$ds.'numero-indexation.lock';
        ...
        if (flock($fp, LOCK_EX | LOCK_NB)) {
            ...
            $numeros = $this->numeroRepository->findBy(['isValid' => true, 'state' => 'treatment', 'isIndexed' => false], ['updateDate' => 'ASC']);            
    ...
    private function removeOldIndexs(Numero $numero): void
    {
        $indexs = $this->indexationRepository->findBy(['numero' => $numero]);
