...
$( () => {
    ...
    $('#clientRevueFormBloc').remove();

    $('#selected_revue').on('click', function(e) {
        if ($(this).is(':checked')) {
            $('.selected_revue').attr('checked',true);
        } else {
            $('.selected_revue').attr('checked',false);
        }
    });

    $('#selecting_revue').on('click', function(e) {
        if ($(this).is(':checked')) {
            $('.selecting_revue').attr('checked',true);
        } else {
            $('.selecting_revue').attr('checked',false);
        }
    });
